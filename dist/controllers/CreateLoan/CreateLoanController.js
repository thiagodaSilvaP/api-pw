...
const CreateLoanController = (request, response) => __awaiter(void 0, void 0, void 0, function* () {
    const { student, book, deliveryDate } = request.body;
    return yield new LoansRepository_1.LoansRepository(new Loans_1.Loans().loans).create({ data: { student, book, deliveryDate, situation: false } });
});
